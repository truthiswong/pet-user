const hostSso = 'http://hospital.jw.iisu.cn/server/sso/'
...
const install = (Vue, vm) => {
	...
	let testResultPage = (params = {}) => vm.$u.get(hostUser + 'user/consumer/check/result/page', params) // 获取检测结果
	...
	let feePage = (params = {}) => vm.$u.get(hostUser + 'user/consumer/settlement/record/page', params) // 获取消费记录
